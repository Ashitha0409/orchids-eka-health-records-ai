...
import { MongoDBStatus } from "@/components/dashboard/mongodb-status";
...
export default function DoctorDashboard() {
      ...
      try {
        ...
        if (profileData) {
          ...
          setUser({
            ...
            professionalTitle: parsedData.professionalTitle || "Dr.",
  ...
  const greetingName = user.firstName || "Doctor";
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-display text-2xl font-bold text-foreground">
                Good morning, {user.professionalTitle} {greetingName}
              </h1>
